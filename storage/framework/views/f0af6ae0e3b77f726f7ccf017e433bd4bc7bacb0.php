        ...
        <section class="flex-all">
            <div class="flex-left">
                <div class="profile">
                    <nav>
                        <div class="logaut">
                            <a href="<?php echo e(route('logout')); ?>"><i class="fa-solid fa-arrow-right-from-bracket">&nbsp;</i>Logout</a>
                        </div>
                    </nav>
                    <div class="foto"><img src="<?php echo e($user['foto']); ?>"></div>
                    <div class="nome"><?php echo e($user['username']); ?></div>
                </div>
                <div class="line">
                    <p>Vuoi aggiunere un brano alla tua playlist o tra i preferiti?</p> &nbsp; 
                    <p class="button"><a href="<?php echo e(route('search')); ?>">Clicca qui</a></p>
                </div>
                <div class="search">
